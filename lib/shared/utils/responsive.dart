...
class Responsive {
  Responsive(BuildContext context) {
    ...
    _isDesktop = size.width > Const.resolution;
  ...
  double fpM(int designFontSize) => designFontSize * _scaleFactor;
  double fp(int designFontSize) => designFontSize * _webScaleFactor;
}
